#ifndef IRLIBRARY_PUMA6R_H
#define IRLIBRARY_PUMA6R_H
...
namespace IRlibrary {
	class Puma6r {
		...
		public:
			// Constructors
			Puma6r() : l({0, 0, 0}), q({0, 0, 0}), base({0, 0, 0}) { setM(); setSlist();wsCalc(); zeroForwardKinematics(); };
			Puma6r(double l1_i, double l2_i, double l3_i) : l({l1_i, l2_i, l3_i}), q({0, 0, 0}), base({0, 0, 0}) {setM(); setSlist();wsCalc(); zeroForwardKinematics(); };
...
#endif /* ifndef IRLIBRARY_PUMA6R_H */
